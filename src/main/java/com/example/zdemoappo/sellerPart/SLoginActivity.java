...
import com.example.zdemoappo.userPart.MSignUpActivity;
...
public class SLoginActivity extends AppCompatActivity {
    ...
    private void check() {
        String loginOrNot = sharedPreferences.getString("SellerLogin", "");
    ...
    public void goToNext(View view) {
        ...
        /*if (emailTV.getText().toString().equals(email)) {
            if (passwordTV.getText().toString().equals(password)) {
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putString("Sell" +
                        "", "logged in");
                editor.apply();
                startActivity(new Intent(getApplicationContext(), HomeActivity.class));
                finish();
    ...
    public void signUp(View view) {
        startActivity(new Intent(getApplicationContext(), SSignUpActivity.class));
        finish();
    }
}